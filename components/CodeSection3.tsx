          ...
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <div className="mb-10">
              ...
              <p className="mx-auto max-w-3xl mt-0 text-md text-muted-foreground lg:text-md">
                Everything in your controlAll the features you need to manage your email sending, troubleshoot 
                <br /> with detailed logs, and protect your domain reputation – without the friction.
                </p>
            </div>
